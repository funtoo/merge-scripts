...
if [[ ${PV} == "9999" ]] ; then
	...
	if [[ ${PV} == *_alpha* || ${PV} == *_beta* || ${PV} == *_rc* ]]; then
		...
		http://build.funtoo.org/distfiles/grub/${BINFONT}.xz
		http://ftp.osuosl.org/pub/funtoo/distfiles/grub/${BINFONT}.xz
		http://ftp.heanet.ie/mirrors/funtoo/distfiles/grub/${BINFONT}.xz"
	fi
	KEYWORDS="amd64 x86"
	S=${WORKDIR}/${MY_P}
	DO_AUTORECONF="true"
