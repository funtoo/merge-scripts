...
PV_PL="2.1.2"
PATCHVER_PL=""
SRC_URI="http://www.funtoo.org/archive/portage-2.2_rc67-r1.tar.bz2
...
src_install() {
	...
	install -d ${D}/$portage_base || die "bir dir create failed"
	cp -a ${S}/* ${D}/$portage_base || die "big copy failed"	
