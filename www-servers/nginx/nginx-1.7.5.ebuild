...
# current 0.9.12 do not support 1.7.5 version of nginx so we use snapshot
# TODO: tie it to the release version instead of snapshot after developer of the module will release one that compatible with 1.7.5
HTTP_LUA_MODULE_PV="25c4bdd6b68e54f241fff9018ec4aa7a65426b31"
HTTP_LUA_MODULE_P="ngx_http_lua-${HTTP_LUA_MODULE_PV}"
HTTP_LUA_MODULE_URI="https://github.com/openresty/lua-nginx-module/archive/25c4bdd6b68e54f241fff9018ec4aa7a65426b31/lua-nginx-module-25c4bdd6b68e54f241fff9018ec4aa7a65426b31.tar.gz"
...
# accept_language_module (http://wiki.nginx.org/AcceptLanguageModule, unknown license)
...
# http-concat (http://wiki.nginx.org/HttpConcatModule, 2-clause)
...
selinux ssl systemd userland_GNU vim-syntax"
...
src_prepare() {
	epatch "${FILESDIR}/1.4.1/fix-perl-install-path.patch"
