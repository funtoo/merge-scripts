...
SRC_URI="http://vault.centos.org/7.1.1503/updates/Source/SPackages/kernel-${KV_CLASSIC}-${KV_RHEL}.src.rpm -> ${P}.src.rpm"
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${PN}-ext4-fix-data-corruption.patch
