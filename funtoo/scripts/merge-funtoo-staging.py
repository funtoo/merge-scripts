...
shards = {
	...
	"kde" : GitTree("gentoo-kde-shard", "7b08d34458f4e76febd39df7213f5b54917398e0", "repos@localhost:gentoo-kde-shard.git", pull=True),
...
# kde: 7b08d34458f4e76febd39df7213f5b54917398e0 (Updated 19 Dec 2016)
