...
shards = {
	...
	"kde" : GitTree("gentoo-kde-shard", "11e4ffb92c4b29ee0cbae264114de2a6823f570f", "repos@localhost:gentoo-kde-shard.git", pull=True),
...
# kde: 11e4ffb92c4b29ee0cbae264114de2a6823f570f (Updated 4 Jul 2016)
