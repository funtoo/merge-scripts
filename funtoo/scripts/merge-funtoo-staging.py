...
ebuild_modifications = [
	...
	InsertEbuilds(other_overlays["pinsard_overlay"], select=["app-portage/chuse", "dev-python/iwlib", "sci-libs/gdal", "x11-libs/xapps", "x11-wm/qtile"], skip=None, replace=True, merge=True),
