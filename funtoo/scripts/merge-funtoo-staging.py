...
ebuild_modifications = [
	...
	InsertEbuilds(other_overlays["bhenc_overlay"], select=["app-text/dia", "app-text/mpaste", "dev-python/pyqwt", "media-gfx/iscan", "www-apps/joomla", "x11-drivers/nvidia-drivers"], skip=["games-board/pouetchess"], replace=True, merge=True),
