...
shards = {
	...
	"kde" : GitTree("gentoo-kde-shard", "e6817c6a81707ac182a1c96f79f51f9ec27872d7", "repos@localhost:gentoo-kde-shard.git", pull=True),
...
# kde: e6817c6a81707ac182a1c96f79f51f9ec27872d7 (Updated 1 Apr 2016)
