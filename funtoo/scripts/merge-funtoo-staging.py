...
shards = {
	...
	"core" : GitTree("gentoo-core-shard", "9be16c57074e8c61f593601e2655bd4f80d69d3b", "repos@localhost:gentoo-core-shard.git", pull=True)
}
...
# core:	9be16c57074e8c61f593601e2655bd4f80d69d3b (Updated 29 Jan 2016)
