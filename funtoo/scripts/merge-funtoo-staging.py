...
shards = {
	...
	"x11" : GitTree("gentoo-x11-shard", "51cbfa763e6db422251a582ef886737b9952d4d5", "repos@localhost:ports/gentoo-x11-shard.git", pull=True),
...
# x11: 51cbfa763e6db422251a582ef886737b9952d4d5 (Updated 11 Aug 2016)
