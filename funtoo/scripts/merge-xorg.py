...
branch = "gentoo-1.19-snap"
gentoo_staging_w = GitTree("gentoo-staging", "355a7986f9f7c86d1617de98d6bf11906729f108", "repos@localhost:ports/gentoo-staging.git", root="/var/git/dest-trees/gentoo-staging", pull=False)
