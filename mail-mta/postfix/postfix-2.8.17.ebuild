...
inherit eutils multilib ssl-cert toolchain-funcs flag-o-matic pam user systemd
...
SLOT="0"
KEYWORDS="*"
IUSE="cdb doc dovecot-sasl hardened ipv6 ldap ldap-bind mbox mysql nis pam postgres sasl selinux sqlite ssl systemd vda"
