...
DRIVERS_URI="mirror://funtoo/${DRV_VER}"
SDK_VER="xvba-sdk-0.74-404001.tar.gz"
GLES_SDK_VER="GLES_SDK_v31.zip"
GLES_SDK_URI="mirror://funtoo/${GLES_SDK_VER}"
XVBA_SDK_URI="mirror://funtoo/${SDK_VER}"
SRC_URI="${DRIVERS_URI} ${XVBA_SDK_URI} ${GLES_SDK_URI}"
FOLDER_PREFIX="common/"
IUSE="debug +modules qt4 static-libs pax_kernel gdm-hack +vaapi"
...
src_install-libs() {
	...
	newexe ${WORKDIR}/GLES*/${gles_sdk_arch}/libGLESv2.so libGLESv2.so
	newexe ${WORKDIR}/GLES*/${gles_sdk_arch}/libEGL.so libEGL.so
